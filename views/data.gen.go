...
func footerHtml() (*asset, error) {
	path := "/Volumes/gernest/personal/gopath/src/github.com/gernest/wuxia/templates/footer.html"
	name := "footer.html"
...
func headerHtml() (*asset, error) {
	path := "/Volumes/gernest/personal/gopath/src/github.com/gernest/wuxia/templates/header.html"
	name := "header.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
...
// homeHtml reads file data from disk. It returns an error on failure.
func homeHtml() (*asset, error) {
	path := "/Volumes/gernest/personal/gopath/src/github.com/gernest/wuxia/templates/home.html"
	name := "home.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
